<script>
	...
	onMount(() => {
		lettersheight = document.getElementById('text').offsetTop;
	});
</script>
	...
	<nav class="navbar navbar-expand-sm">
		<div class="container-fluid">
			<a href="/" class="brand">
				...
				/>
				<span id="brandname" style="opacity: {y/lettersheight}">VMboards typeware</span>
			</a>
			<button
...
<main>
				...
				<div class="col-6" style="display: flex;">
					<div class="align-self-center" style="width: 80%;">
						...
						<div style="padding-top: 10%;">
							<a href="/projects/vm35#" class="btn btn_light btn-primary">Learn More</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="section dark">
		<div class="container">
			<div class="row">
				<div class="col-5" style="padding-left: 5%; display: flex;">
					<div class="align-self-center" style="width: 80%;">
						<h1>VMK Firmware</h1>
						<h2 style="padding-top: 5%;">COMING IN 2023</h2>
						<!--                    TODO screenshot for VMK-->
						<h3 style="padding-top: 10%;">
							Download and use the most advanced wireless keyboard firmware
						</h3>
						<div style="padding-top: 10%;">
							<a href="/projects/vmk" class="btn btn_dark btn-primary">Download</a>
						</div>
					</div>
				</div>
	...
	<!--TODO make not download but something more correct for the button-->
	<div class="row row-background justify-content-center">
...
<div class="container">
	<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
		<div class="col-md-4 d-flex align-items-center">
			<span class="text-muted">&copy; 2023 VMboards typeware</span>
		</div>
		<ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
			<li class="ms-3">
				<a class="text-muted" href="https://discord.gg/XJ9pgZzQHW"
				><svg class="bi" width="24" height="24"><use xlink:href="#discord" /></svg></a
				>
			</li>
			<li class="ms-3">
				<a class="text-muted" href="https://www.instagram.com/vmboards/"
				><svg class="bi" width="24" height="24"><use xlink:href="#instagram" /></svg></a
				>
			</li>
			<li class="ms-3">
				<a class="text-muted" href="https://vk.com/vmboards"
				><svg class="bi" width="24" height="24"><use xlink:href="#vk" /></svg></a
				>
			</li>
		</ul>
	</footer>
...
<style lang="scss">
	...
	.row-background {
		...
		font-family: 'Raleway', sans-serif;
		margin: -6px 0 0 0;
		background-image: url(/plates.webp);
