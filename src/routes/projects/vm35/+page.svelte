...
<main>
    <div class="subheader">
        <div class="targetbox">
            <div class="targetwrap" on:click={() => window.scrollTo(0, 0)}>
                <img alt="" bind:this={target1} class="target-bg" src="data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='7' ry='7' stroke='%23333' stroke-width='2' stroke-dasharray='4%2c6' stroke-dashoffset='30' stroke-linecap='round'/%3e%3c/svg%3e">
                <div>overview</div>
            </div>

            <div class="targetwrap" on:click={() => window.scrollTo(0, details)}>
                <img alt="" bind:this={target2} class="target-bg" src="data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='7' ry='7' stroke='%23333' stroke-width='2' stroke-dasharray='4%2c6' stroke-dashoffset='30' stroke-linecap='round'/%3e%3c/svg%3e">
                <div>details</div>
            </div>

            <div class="targetwrap" on:click={() => window.scrollTo(0, groupbuy)}>
                <img alt="" bind:this={target3} class="target-bg" src="data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='7' ry='7' stroke='%23333' stroke-width='2' stroke-dasharray='4%2c6' stroke-dashoffset='30' stroke-linecap='round'/%3e%3c/svg%3e">
                <div>group buy</div>
            </div>
        </div>
    </div>
    <div class="section" style="position: relative; top: -40px; margin-bottom: -40px;">
        <div class="container">
            <div class="row screenheight align-items-center" style="height: calc(100vh - 56px) !important; margin: 0;">
                <div class="col-6 firstcol">
                    <div class="video-wrapper" on:click={togglevid}>
                        ...
                        <video
                                ...
                                bind:this={video1}
                        ></video>
                        <img bind:this={img1} style="bind:opacity={opacity1}" class="img" src="/poster.png" alt="VM35 assembled">
                        <img bind:this={img2} style="bind:opacity={opacity2}" class="img" src="/poster2.png" alt="VM35 exploded">
                    </div>
                </div>
                <div class="col-6">
                    <h1>
            ...
            <div class="row screenheight" style="margin: 0;">
                ...
                <div class="col-6 align-content-center" style="margin: auto 0; padding-right: 0;">
                    ...
                    <h4 class="overview-text">
                        Each one of the 35 hotswappable keys can be remapped to your liking, and certain keys can be switched for 2U ones to fit every possible setup.
                    </h4>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row screenheight" style="margin: 0;">
                <div class="col-6 justify-content-center" style="margin: auto 0; padding-left: 0;">
                    <h2 class="overview-text">
                        Take it wherever you want and don't worry about charging.
                    </h2>
                    <h4 class="overview-text">
                        Unbelievable battery life is achieved thanks to BLE support and using a high capacity battery.
                    </h4>
                </div>
    ...
    <div class="section dark">
        <div class="container">
            <div class="row screenheight" style="margin: 0;">
                ...
                <div class="col-6 align-content-center" style="margin: auto 0; padding-right: 0;">
                    <h2 class="overview-text">
                        A remarkable combination of look, feel and sound.
                    </h2>
                    <h4 class="overview-text">
                        Gasket mount, FR4 plate and PCB mount stabilizers contribute to the board's soft typing feel and warm sound.
                    </h4>
                </div>
            </div>
        </div>
                ...
                <div class="col-6 justify-content-center" style="margin: auto 0; padding-left: 0;">
                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-indicators">
                            <button type="button" class="thumbo active" style="background-image: url(/vm1.png); margin-left: 0; border-bottom-left-radius: 0.55rem" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" class="thumbo" style="background-image: url(/vm2.png);" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"></button>
                            <button type="button" class="thumbo" style="background-image: url(/vm3.png); margin-right: 0; border-bottom-right-radius: 0.55rem" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        </div>
                    </div>
                </div>
                <div class="col-6 align-content-center" style="margin: auto 0; padding-right: 0;">
...
<style>
    ...
    #videoelement1, #videoelement2, .img {
        position: absolute;
        top: 50%;
        left: 50%;
